...
- (void)viewDidLoad
{
    ...
    //    UIButton *incentiveBut =[[UIButton alloc] initWithFrame:CGRectMake(20,
    //    500, 200, 50)]; [incentiveBut setTitle:@"插屏视频"
    //    forState:UIControlStateNormal]; [incentiveBut addTarget:self
    //    action:@selector(incentiveBut)
    //    forControlEvents:UIControlEventTouchUpInside]; [incentiveBut
...
- (void)readDocument
{
    MARDocument *doc = [[MARDocument alloc]
        initWithFileURL:[MARiCloudHandle getUbiquityContauneURLWithFileName:@"自定义文件名称.txt"]];
